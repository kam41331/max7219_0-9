      ...
      0082B7                         65 _milis:
      0082B7 52 04            [ 2]   66 	sub	sp, #4
                                     67 ;	./src/milis.c: 20: TIM4_ITConfig(TIM4_IT_UPDATE, DISABLE);
                                     68 ; genIPush
      0082B9 4B 00            [ 1]   69 	push	#0x00
                                     70 ; genSend
      0082BB A6 01            [ 1]   71 	ld	a, #0x01
                                     72 ; genCall
      0082BD CD 83 B5         [ 4]   73 	call	_TIM4_ITConfig
                                     74 ;	./src/milis.c: 21: tmp = miliseconds;
                                     75 ; genAssign
      0082C0 CE 00 03         [ 2]   76 	ldw	x, _miliseconds+2
      0082C3 90 CE 00 01      [ 2]   77 	ldw	y, _miliseconds+0
      0082C7 17 01            [ 2]   78 	ldw	(0x01, sp), y
                                     79 ;	./src/milis.c: 22: TIM4_ITConfig(TIM4_IT_UPDATE, ENABLE);
                                     80 ; genIPush
      0082C9 89               [ 2]   81 	pushw	x
      0082CA 4B 01            [ 1]   82 	push	#0x01
                                     83 ; genSend
      0082CC A6 01            [ 1]   84 	ld	a, #0x01
                                     85 ; genCall
      0082CE CD 83 B5         [ 4]   86 	call	_TIM4_ITConfig
      0082D1 85               [ 2]   87 	popw	x
                                     88 ;	./src/milis.c: 23: return tmp;
                                     89 ; genReturn
      0082D2 16 01            [ 2]   90 	ldw	y, (0x01, sp)
                                     91 ; genLabel
      0082D4                         92 00101$:
                                     93 ;	./src/milis.c: 24: }
                                     94 ; genEndFunction
      0082D4 5B 04            [ 2]   95 	addw	sp, #4
      0082D6 81               [ 4]   96 	ret
      ...
      0082D7                        104 _init_milis:
                                    105 ;	./src/milis.c: 29: TIM4_TimeBaseInit(PRESCALER, PERIOD);       // (16MHz / 128) / 125 = 1000Hz
                                    106 ; genIPush
      0082D7 4B 7C            [ 1]  107 	push	#0x7c
                                    108 ; genSend
      0082D9 A6 07            [ 1]  109 	ld	a, #0x07
                                    110 ; genCall
      0082DB CD 85 65         [ 4]  111 	call	_TIM4_TimeBaseInit
                                    112 ;	./src/milis.c: 30: TIM4_ClearFlag(TIM4_FLAG_UPDATE);
                                    113 ; genSend
      0082DE A6 01            [ 1]  114 	ld	a, #0x01
                                    115 ; genCall
      0082E0 CD 85 ED         [ 4]  116 	call	_TIM4_ClearFlag
                                    117 ;	./src/milis.c: 31: TIM4_ITConfig(TIM4_IT_UPDATE, ENABLE);
                                    118 ; genIPush
      0082E3 4B 01            [ 1]  119 	push	#0x01
                                    120 ; genSend
      0082E5 A6 01            [ 1]  121 	ld	a, #0x01
                                    122 ; genCall
      0082E7 CD 83 B5         [ 4]  123 	call	_TIM4_ITConfig
                                    124 ;	./src/milis.c: 32: ITC_SetSoftwarePriority(ITC_IRQ_TIM4_OVF, ITC_PRIORITYLEVEL_1);     // nízká priorita pøerušení
                                    125 ; genIPush
      0082EA 4B 01            [ 1]  126 	push	#0x01
                                    127 ; genSend
      0082EC A6 17            [ 1]  128 	ld	a, #0x17
                                    129 ; genCall
      0082EE CD 84 6F         [ 4]  130 	call	_ITC_SetSoftwarePriority
                                    131 ;	./src/milis.c: 33: enableInterrupts();
                                    132 ;	genInline
      0082F1 9A               [ 1]  133 	rim
                                    134 ;	./src/milis.c: 34: TIM4_Cmd(ENABLE);
                                    135 ; genSend
      0082F2 A6 01            [ 1]  136 	ld	a, #0x01
                                    137 ; genCall
      0082F4 CC 84 3E         [ 2]  138 	jp	_TIM4_Cmd
                                    139 ; genLabel
      0082F7                        140 00101$:
                                    141 ;	./src/milis.c: 35: }
                                    142 ; genEndFunction
